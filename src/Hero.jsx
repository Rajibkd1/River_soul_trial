...
export function Hero() {
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Content wrapper */}
      <div className="relative z-10 px-2 lg:px-8 py-12">
        {/* Main hero section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start mb-20">
          {/* Left content */}
          <div className="flex flex-col justify-start">
            ...
            <h2 className="text-xl lg:text-2xl text-white/90 mb-8 font-medium whitespace-nowrap ">
